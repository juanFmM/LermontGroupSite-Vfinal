...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projectsDataExtended = {
    'planta-tratamiento': {
      images: [
        ...
        'imagenes 2.0/PALACION DE BELLAS ARTES/LISTA 3.jpg',
        'imagenes 2.0/PALACION DE BELLAS ARTES/LISTA 5.jpg',
        'imagenes 2.0/PALACION DE BELLAS ARTES/LISTA 1.jpg',
      ],
    ...
    'pavimentacion': {
      images: [
        ...
        'imagenes 2.0/PALACIO PRESIDENCIAL - 2023 - SD/PALACIO PRESIDENCIAL - 2023 - SD/LISTO PROCESO DE ARRANQUE (5.5).jpg',
        'imagenes 2.0/PALACIO PRESIDENCIAL - 2023 - SD/PALACIO PRESIDENCIAL - 2023 - SD/LISTO PROCESO DE ARRANQUE (5).jpg',
        'imagenes 2.0/PALACIO PRESIDENCIAL - 2023 - SD/PALACIO PRESIDENCIAL - 2023 - SD/LISTO PROCESO INSTALACION 4 (6).jpg'
      ],
    ...
    'iluminacion': {
      images: [
        ...
        'imagenes 2.0/INSTALACIÓN DE CHILLER PGR - 2025 - SD/LLEGADA CHILLER (1).jpg',
        'imagenes 2.0/INSTALACIÓN DE CHILLER PGR - 2025 - SD/LLEGADA CHILLER NUEVO (1.5).jpg',
        'imagenes 2.0/INSTALACIÓN DE CHILLER PGR - 2025 - SD/MONTAJE CHILLER NUEVO (4).jpg'
      ],
  ...
  function initProjectModals() {
    ...
    const modalCarouselIndicators = $('#modalCarouselIndicators');
    const modalPrevBtn = $('#modalPrevBtn');
    const modalNextBtn = $('#modalNextBtn');
    const currentSlideElement = $('#currentSlide');
    const totalSlidesElement = $('#totalSlides');
    ...
    function createCarousel(images) {
      ...
      if (totalSlidesElement) totalSlidesElement.textContent = images.length.toString();
    ...
    // Detener auto-slide cuando el usuario interactúa con el carrusel
  ...
  /* =====================
     Navegación táctil para carrusel
     ===================== */
